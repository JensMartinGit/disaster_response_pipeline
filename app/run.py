...
def index():
    ...
    graphs = [
        ...
        # Bar chart for Distribution of Message Genres
        {
            'data': [
                Bar(
                    x=genre_names,
        ...
        # Bar chart for Distribution of Message Categories
        {
            'data': [
                Bar(
                    x=message_names,
        ...
        # Grouped bar chart for Distribution of Requests and Offers by Genre
        {
            'data': [
                Bar(
                    name='Requests',
